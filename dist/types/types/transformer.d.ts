...
type ErrorMapCondition = 'includes' | 'startsWith' | 'endsWith' | 'equals' | 'notEquals' | 'contains' | 'notContains' | 'matches' | 'notMatches' | 'instanceOf' | 'enum';
type _ErrorMapBase = {
...
export type ErrorMapOutBase<T, C> = 'ThrowOriginalError' | ErrorMapIfOutPass | ErrorMapIfOutErrorInstance<T, C> | ErrorMapIfOutString | ErrorMapIfOutCustomError;
/**
