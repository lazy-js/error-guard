...
exports.Console = exports.styles = exports.fgColors = exports.bgColors = void 0;
...
class Console {
    static log(message, { fgColor, bgColor, style } = {
        ...
        if (!colorString) {
            colorString = exports.bgColors[bgColor !== null && bgColor !== void 0 ? bgColor : 'white'] + exports.fgColors[fgColor !== null && fgColor !== void 0 ? fgColor : 'black'] + exports.styles[style !== null && style !== void 0 ? style : 'reset'];
            this.colorCache.set(cacheKey, colorString);
        }
        console.log(colorString + message + exports.styles.reset);
    }
...
Console.bgColors = exports.bgColors;
Console.fgColors = exports.fgColors;
Console.styles = exports.styles;
